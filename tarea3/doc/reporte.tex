...
\begin{lstlising}
  ./build/ARM/gem5.opt --debug-flags=O3PipeView --debug-start=0 --debug-file=trace.out configs/example/se.py --cpu-type=detailed --caches -c tests/test-progs/hello/bin/arm/linux/hello
\end{lstlisting}
