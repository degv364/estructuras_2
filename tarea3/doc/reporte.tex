...
este nivel extra, reconectando los buses de comunicación de manera adecuada y agregando uno más para
comunicar el nivel L3 con la memoria principal del sistema. Este código se muestra a continuación:
